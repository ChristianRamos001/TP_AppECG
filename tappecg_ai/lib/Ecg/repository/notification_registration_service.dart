...
import '../model/device_installation.dart';
import 'device_installation_service.dart';

class NotificationRegistrationService {
  static const notificationRegistration =
  const MethodChannel('smartheartmonitoring.pe.tappecg_ai/notificationregistration');
  ...
  Future<void> deregisterDevice() async {
    ...
    var response = await http
        .delete(Uri.parse(installationsUrl + deviceId.toString()), headers: {"apikey": apikey});
